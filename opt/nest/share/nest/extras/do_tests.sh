...
TEST_BASEDIR="/home/ubuntu/nest_server_codes/opt/nest/share/doc/nest"
...
PYTHON_HARNESS="/home/ubuntu/nest_server_codes/opt/nest/share/nest/extras/do_tests.py"
...
echo >  "${TEST_LOGFILE}" "NEST v. 2.8.0 testsuite log"
echo >> "${TEST_LOGFILE}" "======================"
