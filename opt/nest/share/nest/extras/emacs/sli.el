(setq load-path (cons "/home/ubuntu/nest_server_codes/opt/nest/share/nest/extras/emacs" load-path))
...
(defvar sli-mode-developer-menu-def
 '("NEST Trac"
   ["SVN status /home/ubuntu/nest_server_codes/nest-2.8.0" sli-svn-status t]
   "-"
...
(defun sli-insert-doc-header ()
  ...
  (interactive)
  (insert-file "/home/ubuntu/nest_server_codes/opt/nest/share/doc/nest/doc_header.txt")
)
...
(defun sli-svn-status ()
  (interactive)
  (require 'psvn)
  (svn-status "/home/ubuntu/nest_server_codes/nest-2.8.0")
  )
...
(defun sli-helpindex-text ()
  (interactive)
  (view-file-other-window "/home/ubuntu/nest_server_codes/opt/nest/share/doc/nest/help/helpindex.hlp")
  )
(defun sli-helpindex-default ()
  (interactive)
  (browse-url "file:/home/ubuntu/nest_server_codes/opt/nest/share/doc/nest/help/helpindex.html")
  )
(defun sli-helpindex-firefox ()
  (interactive)
  (browse-url-firefox "file:/home/ubuntu/nest_server_codes/opt/nest/share/doc/nest/help/helpindex.html")
  )
(defun sli-helpindex-kde ()
  (interactive)
  (browse-url-kde "file:/home/ubuntu/nest_server_codes/opt/nest/share/doc/nest/help/helpindex.html")
  )
(defun sli-helpindex-w3 ()
  (interactive)
  (browse-url-w3 "file:/home/ubuntu/nest_server_codes/opt/nest/share/doc/nest/help/helpindex.html")
  )
...
(defun sli-help-command (command)
  ...
  (let (
        (cc-filename  (concat "/home/ubuntu/nest_server_codes/opt/nest/share/doc/nest/help/cc/" command ".hlp"))
        (sli-filename (concat "/home/ubuntu/nest_server_codes/opt/nest/share/doc/nest/help/sli/" command ".hlp"))
        )
...
(defun sli-helpdesk-default ()
  (interactive)
  (browse-url "file:/home/ubuntu/nest_server_codes/opt/nest/share/doc/nest/index.html")
  )
(defun sli-helpdesk-firefox ()
  (interactive)
  (browse-url-firefox "file:/home/ubuntu/nest_server_codes/opt/nest/share/doc/nest/index.html")
  )
(defun sli-helpdesk-kde ()
  (interactive)
  (browse-url-kde "file:/home/ubuntu/nest_server_codes/opt/nest/share/doc/nest/index.html")
  )
(defun sli-helpdesk-w3 ()
  (interactive)
  (browse-url-w3 "file:/home/ubuntu/nest_server_codes/opt/nest/share/doc/nest/index.html")
  )
